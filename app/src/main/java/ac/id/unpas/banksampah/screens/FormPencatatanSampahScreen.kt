...
import ac.id.unpas.banksampah.ui.theme.Purple700
import ac.id.unpas.banksampah.ui.theme.Teal200
...
@Composable
fun FormPencatatanSampahScreen(navController : NavHostController, id: String? = null, modifier: Modifier =
    Modifier) {
